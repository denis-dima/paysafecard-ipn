...
<div class="container theme-showcase" role="main">
    ...
    if (count($_POST) > 0) {
        ...
        if ($response == false) {
            ...
            if (isset($response["redirect"])) {
                ?>
                <script>
                    window.location.href = "<?php echo $response["redirect"]['auth_url']?>"
                </script>
                <?php
            }
        }
    ...
    <div class="page-header">
        <h1>Payment</h1>
        <p>Make a payment with paysafecard <img
                src="https://www.paysafecard.com/fileadmin/Website/Dokumente/B2B/logo_paysafecard.jpg" height="48px"/>
        </p>
    </div>
    ...
    <div class="row">
                ...
                <div class="panel-body">
                    ...
                    <form method="POST">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" name="amount" class="form-control" value="0.10"
                                   id="amount">
                        </div>
                        <div class="form-group">
        ...
        <div class="col-sm-6">
            ...
            <p>
                Pay by simply entering the 16-digit paysafecard PIN or sign up for your personal my paysafecard payments
                account, top it up with your PINs and pay with just your username and password.
            </p>
            <p>
                More information is available at <a href="http://www.paysafecard.com" target="_blank">
                    www.paysafecard.com </a>
            </p>
            </p>
